//by /u/wiz0floyd on Reddit

function CableRouter(str){
  var directions = str.split(",");
  var visited = [];
  var x = 0; //central port 0,0
  var y = 0;
 
  for (let i = 0; i < directions.length; i++){
    var current = directions[i];
    var dir = current.charAt(0);
    var dist = current.substring(1,999);
 
    if (dir == "U"){
      //console.log(`Moving up ${dist}`);
      for (dist; dist > 0; dist--){
        y++
        //console.log(`Moving up 1 to ${x},${y}`)
        var pt = `${x},${y}`
      ...
      //console.log(`Moving down ${dist}`);
      for (dist; dist > 0; dist--){
        y--
        //console.log(`Moving down 1 to ${x},${y}`)
        var pt = `${x},${y}`
      ...
      //console.log(`Moving right ${dist}`);
      for (dist; dist > 0; dist--){
        x++
        //console.log(`Moving right 1 to ${x},${y}`)
        var pt = `${x},${y}`
      ...
      //console.log(`Moving left ${dist}`);
      for (dist; dist > 0; dist--){
        x--
        //console.log(`Moving left 1 to ${x},${y}`)
        var pt = `${x},${y}`
